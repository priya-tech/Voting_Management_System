    	...
    	<div class="row">
    		...
    		<div class="col-sm-4" style="border:2px solid gray;padding:50px;">
    			...
    			<div class="page-header">
    				<h2 class="specialHead">Feedbacks</h2>
            <a  class="btn btn-success" href="feedback.html"> <strong>Add Your Feedback</strong></a>
    			</div>
          <?php
            session_start();
            ...
            if($row=$res->num_rows > 0){
              ...
              while($row = $res->fetch_assoc()) {
                    echo "<h4>". $row["message"]. "</h4><p> By " . $row["name"]. "</p><br><hr>";
                    }
                 echo "</table>";
             }
             else {
