      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          <ul class="nav navbar-nav">
            <li><a href="add_voter.html"><span class="subFont"><strong>Add Voters</strong></span></a></li>
            <li><a href="add_candidate.html"><span class="subFont"><strong>Add Candidate</strong></span></a></li>
            <li><a href="delete_candidate.html"><span class="subFont"><strong>Delete Candidate</strong></span></a></li>
            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>BJP - ". $BJP ." Votes</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Congress - ". $INC ." Votes</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if($row=$res->num_rows > 0){
                  while($row = $res->fetch_assoc()) {
                    $user = $row["name"];
                    $userval = 0;
                    $sql ="SELECT * FROM tbl_users WHERE voted_for='$user'";
                    $result= mysqli_query($conn, $sql);
                    ...
                    if(mysqli_num_rows($result)>0)
                    {
                      ...
                      $user_value= $userval*10;

                      echo "<strong>" .$user. " - </strong>";
                      echo "<strong>" .$userval. " Votes</strong><br>";
                      echo "
                      <div class='progress'>
                        <div class='progress-bar progress-bar-warning' role='progressbar' aria-valuenow=\"70\" aria-valuemin=\"0\" aria-valuemax=\"100\" style='width: ".$user_value."%'>
