...
<html lang="en">
  ...
  <body>
    ...
    <a  class="btn btn-success" href="index.html"> <strong>Exit</strong></a><br>
    ...
    <div class="container" style="padding:100px;">
      <div class="row">
        ...
        <div class="col-sm-3">
          ...
          <h5 class="normalFont text-center">Rahul Gandhi; is the Vice-President of the Indian National Congress party and the Chairperson of the Indian Youth Congress and the National Students Union of India.</h5>
            <hr>
            <ul class="text-left">
        ...
        <?php
          ...
          if($row=$res->num_rows > 0){
            ...
            echo "<img src='images/profilepic.png' class='img img-thumbnail' style='width:200px;height:200px;' alt=''>";
            echo "<h4 class='normalFont text-center'>". $row["name"]. "</h4><br>";
            echo "<ul class='text-left normalFont'>";
            echo "<li>Born on:". $row["dateofbirth"]. "</li>";
            echo "<li>Education:". $row["education"]. "</li>";
            echo "<li>Parents:". $row["parents"]. "</li>";
            echo "<li>Awards:". $row["awards"]. "</li>";
